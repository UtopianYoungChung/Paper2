...
#| message: false
#| label: tbl-1
#| tbl-cap: change in birth rate by age group

numbirth_2044 <- read.csv(here::here("inputs/data/educ/numbirths_educ_2044.csv"))
numbirth_2044 %>% 
  kable(col.name=c("Age Group","Birth Rate Chage"),booktabs = TRUE,show_col_types=FALSE,linesep="")
```
