...
#| message: false
#| label: fig-3
#| fig-cap: Race and Ethnicity (ages 20-24 from 2000 to 2020)
...
Figure 4. Relationship between changes in birth rates and potential explanatory factors (@fig-4).
```{r}
#| echo: false
#| warning: false
#| message: false
...
fig4b<-fig4_data %>% 
  ...
  geom_point(size=0)+
  labs(
    title = "Change in childcare expenditures",
    x = "US dollar",
    y = "birthrate") +
...
fig4c <-fig4_data %>% 
  ...
  geom_point(size=0)  +
  labs(
    title = "Change in rental housing costs",
    x = "US dollar",
    y = "birthrate") +
  geom_text(aes(label = stname),size=2) +
...
fig4e<-fig4_data %>% 
  ...
  geom_point(size=0)  +
  labs(
    title = "Change in per capita student loan debt",
    x = "US dollar",
    y = "birthrate") +
  geom_text(aes(label = stname),size=2) +
